...
const RenderNotification = (props, context) => (
    <div className={styles.container}>
        {props.list.map(noti => <UserDisplay noti={noti} key={noti.id}/>)}
    </div>
);
...
const UserDisplay = (props, context) => {
    return (
            <div className={styles.column}>
                <img src={props.noti.creator.profile_image || require("images/noPhoto.jpg")} alt={props.noti.creator.username} className={styles.avatar} />
                ...
                <img src={props.noti.image ? props.noti.image.file : require("images/noFollow.jpg")} 
